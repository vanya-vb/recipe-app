...
export default function RegisterPage() {
    ...
    return (
        <section className="flex h-screen flex-col justify-center px-6 py-27 lg:px-8 bg-[linear-gradient(to_bottom,rgba(0,0,0,0.85),rgba(0,0,0,0.9)),url('https://images.unsplash.com/photo-1514986888952-8cd320577b68?q=80&w=1176&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-no-repeat bg-center bg-cover">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action={registerHandler} className="space-y-6">
                    ...
                    <div>
                        <button
                            type="submit"
                            className="flex w-full justify-center rounded-md bg-olivine px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-olivine/70 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-olivine/70 cursor-pointer" 
                        >
                            Sign Up
                        </button>
                    </div>
